...
void RezervareAbonament::ValidareIdRezervare() const {
    std::cout
            << "In cazul clientilor care au abonament la lantul nostru de restaurante, nr. abonamentului va deveni id-ul lor de identificare in baza noastra de date.\n";
    std::cout << "In plus, acestia beneficiaza de reducere de 10% daca nota de plata depaseste suma de 150 de lei.\n";
    if (areAbonament)
        std::cout << "Stare abonament: activ\n";
    else
        std::cout << "Stare abonament: inactiv\n";
}
